...
public class TestController {
    ...
    public void loginCookie(@RequestBody(required = false) LoginData loginData, HttpServletResponse httpResponse) throws Exception {
        ...
        org.apache.http.cookie.Cookie casCookie = HttpClient.getCasServerCookieByHttpClientCall("", casLoginData, HttpMethod.Post);
    ...
    public void restLogin(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        HttpClient.getCasServerCookieByHttpClientCall("", casLoginData, HttpMethod.Post);
