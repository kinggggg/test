...
public class CyclicBarrierTest01 {
    ...
    public static void check() {
        ...
        Integer pos = CyclicBarrierTest01.pos.remove(0);
        Integer dos = CyclicBarrierTest01.dos.remove(0);
    ...
    public static void checkAll(CyclicBarrier barrier) {
        Thread t1 = new Thread(() -> {
            while (true) {
                ...
                try {
                    //如果不等待一下会抛出BrokenBarrierException异常？？？？？？
//                    TimeUnit.MILLISECONDS.sleep(2);
                    barrier.await();
                } catch (InterruptedException e) {
                    e.printStackTrace();
                } catch (BrokenBarrierException e) {
                    System.out.println("1111111" + barrier.isBroken());
                    e.printStackTrace();
                }
            }
        });
...
//                    TimeUnit.SECONDS.sleep(2);
                    ...
                    System.out.println("2222222" + barrier.isBroken());
                    e.printStackTrace();
                }
            }
        });
